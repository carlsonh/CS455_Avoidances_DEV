...
public class ObstAvoid : Seek
{
    ...
    public override SteeringOutput getSteering()
    {
        ...
        if (Physics.Raycast(character.transform.position, _ray, out _hit, _lookAheadDist))
        {
            Debug.DrawRay(character.transform.position, _ray * _hit.distance, Color.red, 0.1f);
        ...
        {
            Debug.DrawRay(character.transform.position, _ray * _lookAheadDist, Color.green, 0.1f);
